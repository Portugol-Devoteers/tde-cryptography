...
unsigned char multiplicationMatrixEncrypt[4][4] = {
    {0x02, 0x03, 0x01, 0x01},
    {0x01, 0x02, 0x03, 0x01},
    {0x01, 0x01, 0x02, 0x03},
    {0x03, 0x01, 0x01, 0x02}};

unsigned char multiplicationMatrixDecrypt[4][4] = {
    {0x0E, 0x0B, 0x0D, 0x09},
    {0x09, 0x0E, 0x0B, 0x0D},
    {0x0D, 0x09, 0x0E, 0x0B},
    {0x0B, 0x0D, 0x09, 0x0E}};
...
unsigned char getEorLValue(unsigned char n, unsigned char (*table)[16])
{
  int x, y;
  extractXY(n, &x, &y);
